...
namespace Dir.UnitTests
{
    ...
    {
        [TestClass]
        public class EnumValueToStringTests
        {
            [TestMethod]
            ...
            public void should_return_as_is_if_contains_only_values_from_enum_definition()
            {
                ...
                Assert.AreEqual("AppendData, ChangePermissions", sut.EnumValueToString());
            }
            ...
            public void should_return_custom_value_if_values_not_only_from_enum_definition()
            {
                ...
                Assert.AreEqual("custom (270467583): AppendData, ChangePermissions, CreateFiles, Delete, DeleteSubdirectoriesAndFiles, ExecuteFile, FullControl, Modify, Read, ReadAndExecute, ReadAttributes, ReadData, ReadExtendedAttributes, ReadPermissions, Synchronize, TakeOwnership, Write, WriteAttributes, WriteExtendedAttributes + possibly something else", sut.EnumValueToString());
            }
        }
    }
}
